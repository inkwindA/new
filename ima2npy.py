...
def save_dataset(args):
    ...
    os.makedirs(os.path.join(args.save_path, 'ldct'))
    os.makedirs(os.path.join(args.save_path, 'ndct'))
    ...
    for p_ind, patient in enumerate(patients_list):
        ...
        for path_ in [patient_input_path, patient_target_path]:
            ...
            for pi in range(len(full_pixels)):
                io = 'ldct' if 'ldct' in path_ else 'ndct'
                f = normalize_(full_pixels[pi], args.norm_range_min, args.norm_range_max)
                f_name = '{}/{}_{}mm_{}.npy'.format(io, patient, args.mm, pi)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default='dataset/1mm_d')
    parser.add_argument('--save_path', type=str, default='save/ima2npy')

    parser.add_argument('--test_patient', type=str, default='L067')
