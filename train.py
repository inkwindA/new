...
arg_parser.add_argument("--init_lr", type=float, default=2e-4)
arg_parser.add_argument("--final_lr", type=float, default=2e-4)
arg_parser.add_argument("--cos_lr", type=bool, default=True)
arg_parser.add_argument('--b1', type=float, default=0.5)
